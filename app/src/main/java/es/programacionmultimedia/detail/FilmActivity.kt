...
class FilmActivity : AppCompatActivity() {
    ...
    //berfungsi menghubungkan layout activity menggunakan ActivityFilmBinding.
    ...
    //Menggunakan Glide untuk memuat gambar poster film.
        // Menggunakan Dagger Hilt (@AndroidEntryPoint dan @Inject) untuk melakukan injeksi dependensi, dalam hal ini, variabel logger diinjeksi.
        logger.log("Creating Activity and binding layout")
        //Mengatur beberapa elemen tampilan awal, seperti gambar poster, teks, dan tombol.
        ...
        //Menggunakan viewModel untuk memuat detail film berdasarkan ID yang diterima melalui intent.
        val id = intent?.extras?.getInt(FILM_ID)?: 512195
        //Menggunakan FilmViewModel sebagai bagian dari arsitektur Android Jetpack untuk mengelola data terkait film.

        viewModel.loadFilm(id)
        //Menggunakan fungsi observe untuk memperbarui tampilan saat data film berubah.
        ...
        //Membuat fungsi launchYoutube untuk membuka video YouTube dengan menggunakan intent.
            if(it.videoId == null) {
